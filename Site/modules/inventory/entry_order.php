...
<main class="container mt-4">
    ...
    <form method="POST" class="needs-validation" novalidate id="orderForm">
            ...
            <div class="card-body p-2">
                <div class="table-responsive">
                    <table class="table table-sm">
                        <!-- MODIFIED: Reordered the table headers for the new flow -->
        ...
        <div class="col-12 mt-4"><button class="btn btn-primary btn-lg" type="submit"><i class="bi bi-save"></i> Create Order & Update Stock</button></div>
    </form>
</main>

<!-- MODIFIED: Reordered the table cells to match the new header flow -->
