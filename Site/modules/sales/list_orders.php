...
// Corrected to include the main application layout for proper sidebar integration.
...
<!-- Using the main application layout structure -->
                ...
                <div class="card-body">
                    <form id="orderSearchForm" class="row g-3">
                        <div class="col-md-3">
                            ...
                            <input type="text" class="form-control" id="search_order_id">
                        </div>
                        <div class="col-md-3">
