...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        foreach ($item_ids as $index => $item_id) {
            if (!empty($item_id)) { // Only process rows that have a selected item
                $items_to_process[] = [
                    'item_id'    => $item_id,
        ...
        // Call the new function to process the PO
        ...
        // The form will clear on success because we don't preserve POST data.
            ...
            <form method="POST" class="needs-validation" novalidate id="poForm">
                    ...
                    <div class="card-body">
                        <div class="row g-3">
                            <div class="col-md-4">
                                ...
                                <div class="invalid-feedback">Please provide a PO date.</div>
                            </div>
                            <div class="col-md-8">
                             ...
                             <div class="col-12">
                                ...
                                <textarea class="form-control" id="remarks" name="remarks" rows="2" placeholder="e.g., Delivery instructions, contact person..."></textarea>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card mt-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <button type="button" class="btn btn-sm btn-success" id="addPoItemRow">
...
<!-- Hidden HTML template for a new item row -->
<template id="poItemRowTemplate">
    <tr class="po-item-row">
        ...
        <td>
            <input type="number" class="form-control form-control-sm quantity-input" name="items[quantity][]" min="1" step="1" required>
            <div class="invalid-feedback">Req.</div>
        </td>
        <td>
            <input type="number" class="form-control form-control-sm cost-price-input" name="items[cost_price][]" min="0.01" step="0.01" required>
            <div class="invalid-feedback">Req.</div>
        </td>
        <td>
